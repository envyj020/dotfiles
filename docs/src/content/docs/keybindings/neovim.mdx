...
<Aside icon="vim" title="Neovim Leader Key: <Space>">
  Please note, many of the keybindings listed below reference actions or
  commands provided by custom plugins.
</Aside>
...
| Key         | Mode   | Description                             |
| ----------- | ------ | --------------------------------------- |
| `<Del>`     | Insert | Delete previous word                    |
| `<Del>`     | Normal | Delete previous word                    |
